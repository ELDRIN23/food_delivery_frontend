...
const Cart = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-gray-900 text-white p-4 sm:p-8">
      {/* Cart Items Section */}
      <div className="flex-grow flex flex-col px-4 sm:px-8">
        <h1 className="text-3xl sm:text-4xl font-bold mb-6 sm:mb-8 text-yellow-400">Your Cart</h1>
        {cartItems.length === 0 ? (
          <p className="text-gray-500 text-lg">Your cart is empty</p>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 w-full">
            {cartItems.map((item) => (
              <div key={item?._id} className="bg-gray-800 p-4 rounded-xl shadow-lg transition transform hover:scale-105">
                ...
                <div className="mt-3">
                  <h1 className="text-lg sm:text-xl font-semibold">{item?.dish_name}</h1>
                  <p className="text-gray-400">Price: {item?.price_per_item} Rs</p>
      ...
      {/* Checkout Section */}
      <div className="w-full lg:w-1/3 sticky top-20 p-6 bg-gray-800 rounded-xl shadow-lg mt-6 lg:mt-0 lg:ml-10">
